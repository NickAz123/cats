...
//     const catDesc = breedDetails('Balinese');
...
//     assert.equal(expectedDesc, catDesc);
//   })

//   it(`returns undefined if there is no description available`, () => {
//     const catDesc = breedDetails(`Calico`);
